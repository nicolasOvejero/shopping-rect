...
export const signUpSuccess = (user, additionalDetails) => createAction(USER_ACTIONS_TYPES.SIGN_UP_SUCCESS, { user, additionalDetails });

export const signUpFailed = (error) => createAction(USER_ACTIONS_TYPES.SIGN_UP_FAILED, error);
...
export const signOutFailed = (error) => createAction(USER_ACTIONS_TYPES.SIGN_OUT_FAILED, error);
